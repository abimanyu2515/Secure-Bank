...
export default function ManageCardsPage({ onNavigate, onLogout }) {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-teal-50 via-emerald-50 to-cyan-50">
      <Sidebar active="cards" onNavigate={onNavigate} onLogout={onLogout} />
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div>
                <p className="text-xs sm:text-sm font-semibold text-teal-600 flex items-center gap-2">
                  Card Management Center <Lock className="w-3 h-3 sm:w-4 sm:h-4" />
                </p>
                <h1 className="text-xl sm:text-2xl font-bold text-gray-800">Manage Cards</h1>
              </div>
            </div>
            <button className="px-3 sm:px-4 py-2 rounded-xl bg-gradient-to-r from-teal-500 to-cyan-500 text-white text-xs sm:text-sm font-semibold shadow hover:shadow-md w-full sm:w-auto">
              Apply for New Card
            </button>
          </header>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-teal-50 rounded-2xl p-4 border border-teal-100">
                      ...
                      <p className="text-xl font-bold text-gray-800">{card.limit}</p>
                    </div>
                    <div className="bg-emerald-50 rounded-2xl p-4 border border-emerald-100">
                      <p className="text-sm text-gray-600">Available Limit</p>
                      <p className="text-xl font-bold text-gray-800">{card.available}</p>
                    </div>
                    <div className="bg-orange-50 rounded-2xl p-4 border border-orange-100">
                      <p className="text-sm text-gray-600">Rewards Earned</p>
                      <p className="text-xl font-bold text-gray-800">3,245 pts</p>
                    </div>
                  </div>
            ...
            <section className="space-y-6">
              <div className="bg-white rounded-2xl p-6 border-2 border-teal-100 shadow">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <p className="text-sm text-emerald-500 font-semibold">Security</p>
                ...
                <ul className="space-y-4 text-sm text-gray-600">
                  <li className="flex items-start gap-2">
                    ...
                    Enable/disable online, POS, and international usage instantly.
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-2 h-2 bg-teal-500 rounded-full mt-2" />
              ...
              <div className="bg-white rounded-2xl p-6 border-2 border-orange-100 shadow flex flex-col gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-orange-500 font-semibold">Offers</p>
                    <h3 className="text-lg font-bold text-gray-800">Super Saver</h3>
                  </div>
                </div>
                <p className="text-gray-600">
                  Unlock up to 5% cashback on dining & travel with the new BOI Signature Credit Card.
                </p>
